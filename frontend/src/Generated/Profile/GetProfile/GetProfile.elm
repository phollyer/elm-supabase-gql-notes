module Profile.GetProfile.GetProfile exposing (Input, ProfilesByPk, Response, query)

{-|
This file is generated from ../supabase/queries/profile/getProfile.gql using `elm-gql`
...
decoder_ version_ =
    Json.Decode.succeed Response |> GraphQL.Decode.versionedField
                                            ...
                                            (Json.Decode.nullable
                                                     (Json.Decode.succeed
                                                              ProfilesByPk |> GraphQL.Decode.field
                                                                                          "id"
