module Notes.GetTrashedNotes.GetTrashedNotes exposing (Edges, Node, NotesCollection, Response, query)

{-|
This file is generated from ../supabase/queries/notes/getTrashedNotes.gql using `elm-gql`
