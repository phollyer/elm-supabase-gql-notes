module Notes.RestoreNote.RestoreNote exposing (Input, Records, Response, UpdateNotesCollection, mutation)

{-|
This file is generated from ../supabase/queries/notes/restoreNote.gql using `elm-gql`
    ...
    Json.Decode.succeed Response |> GraphQL.Decode.versionedField
                                            ...
                                            (Json.Decode.succeed
                                                     UpdateNotesCollection |> GraphQL.Decode.field
                                                                                          "affectedCount"
                                                                                          Json.Decode.int |> GraphQL.Decode.field
                                                                                                                         "records"
                                                                                                                         (Json.Decode.list
                                                                                                                                      (Json.Decode.succeed
